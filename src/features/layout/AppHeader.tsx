...
export function AppHeader({ onStationSelect }: AppHeaderProps) {
  return (
    <header className='relative z-10 flex h-16 justify-between gap-2 border-b-2 border-blue-200 p-2 lg:h-20'>
      <div className='flex'>
        <a
      ...
      <nav
        className='flex justify-end gap-2 px-2 lg:gap-4 lg:px-5 xl:gap-6 xl:px-7'
        aria-label='사용자 메뉴'
      >
        <button
