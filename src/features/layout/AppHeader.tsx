...
export function AppHeader() {
  return (
    <header className="relative z-10 grid h-16 grid-cols-[auto_minmax(180px,1fr)_auto] items-center border-b border-slate-200 bg-white lg:h-20 lg:grid-cols-[var(--left-panel)_minmax(320px,1fr)_var(--right-panel)]">
      ...
      <div className="ml-1.5 flex h-10.5 w-[calc(100%-12px)] items-center gap-2.5 rounded-xl border border-slate-300 bg-white px-3 text-[13px] text-slate-400 shadow-[0_2px_8px_rgb(15_23_42/5%)] sm:ml-3 sm:w-[calc(100%-24px)] sm:px-4 sm:text-base lg:ml-6 lg:h-12 lg:w-[min(372px,calc(100%-48px))]">
        <SearchIcon />
        <span>정류장, 버스 검색</span>
      </div>
